...
final class TranslationLogScreen extends Screen implements LocalTranslationScreen {
    ...
    private void rebuildWidgets() {
        ...
        addButton(TranslatorUiText.button(12, bottom, 90, BUTTON_HEIGHT,
                new TranslatableText("gui.back"), button -> onClose()));
        addButton(TranslatorUiText.button(108, bottom, 100, BUTTON_HEIGHT,
        ...
        addButton(TranslatorUiText.button(216, bottom, 118, BUTTON_HEIGHT,
                new TranslatableText("screen.universal_translator.log.source_settings"), button ->
                        MinecraftClient.getInstance().openScreen(new TranslationLogSourceScreen(this))));
        pinnedButton = addButton(TranslatorUiText.button(width - 102, bottom, 90, BUTTON_HEIGHT, pinnedText(), button -> {
        ...
        int y = bottom - 54;
        addButton(TranslatorUiText.button(12, y, CONTROL_WIDTH, BUTTON_HEIGHT,
        ...
        addButton(TranslatorUiText.button(92, y, CONTROL_WIDTH, BUTTON_HEIGHT,
    ...
    private void addStepper(int x, int y, String label, int value, int decrement, int increment,
        ...
        addButton(TranslatorUiText.button(clampedX, y, 24, BUTTON_HEIGHT,
                new LiteralText("-"), button -> step(value + decrement, minimum, maximum, action)));
        addButton(TranslatorUiText.button(clampedX + 26, y, 82, BUTTON_HEIGHT,
                new LiteralText(label + " " + value), button -> { }));
        addButton(TranslatorUiText.button(clampedX + 110, y, 24, BUTTON_HEIGHT,
