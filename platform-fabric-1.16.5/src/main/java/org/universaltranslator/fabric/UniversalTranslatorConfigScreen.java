...
final class UniversalTranslatorConfigScreen extends Screen implements LocalTranslationScreen {
    ...
    protected void init() {
        ...
        this.downloadButton = addButton(TranslatorUiText.button(
                left, layout.row(4), layout.buttonWidth, 20, TranslatorUiText.empty(), button -> {
                    if (isLlm()) {
                        ...
                        if (this.client != null) {
                            this.client.openScreen(new UniversalTranslatorDeepSeekConfigScreen(
                                    this, provider, officialModel(provider),
                                    !officialApiKey(provider).isEmpty()));
                        }
                    } else if (isTencent()) {
                        if (this.client != null) {
                            this.client.openScreen(new UniversalTranslatorTencentConfigScreen(
        ...
        this.cacheEditorButton = addButton(TranslatorUiText.button(
                ...
                new TranslatableText("screen.universal_translator.option.cache_editor"), button -> {
                    if (this.client != null) {
                        this.client.openScreen(new UniversalTranslatorCacheScreen(this));
                    }
                }));
        ...
        this.targetLanguage = addButton(new TextFieldWidget(
        ...
        this.targetLanguageButton = addButton(TranslatorUiText.button(
        ...
        this.endpoint = addButton(new TextFieldWidget(
        ...
        addButton(TranslatorUiText.button(left, layout.saveY, layout.buttonWidth, 20,
                new TranslatableText("screen.universal_translator.save"), button -> saveAndApply()));
        addButton(TranslatorUiText.button(layout.right, layout.saveY, layout.buttonWidth, 20,
    ...
    /** 1.16.5 无 setPlaceholder，用 suggestion 模拟空输入占位 */
