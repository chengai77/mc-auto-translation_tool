...
final class UniversalTranslatorDeepSeekConfigScreen extends Screen implements LocalTranslationScreen {
    ...
    protected void init() {
        ...
        addButton(TranslatorUiText.button(left, top + 72, buttonWidth, 20,
                new TranslatableText("screen.universal_translator.deepseek.save"), button -> save()));
        addButton(TranslatorUiText.button(left + buttonWidth + gap, top + 72, buttonWidth, 20,
                new TranslatableText("gui.cancel"), button -> onClose()));
        addButton(TranslatorUiText.button(left + (buttonWidth + gap) * 2, top + 72, buttonWidth, 20,
