...
final class UniversalTranslatorTencentConfigScreen extends Screen implements LocalTranslationScreen {
    ...
    UniversalTranslatorTencentConfigScreen(
        ...
        super(new TranslatableText("screen.universal_translator.tencent.title"));
        this.parent = parent;
    ...
    protected void init() {
        ...
        secretId = addButton(new TextFieldWidget(
        ...
        secretKey = addButton(new TextFieldWidget(
        ...
        addButton(TranslatorUiText.button(left, top + 108, colWidth, 20,
                new TranslatableText("screen.universal_translator.tencent.save"), button -> save()));
        addButton(TranslatorUiText.button(left + colWidth + gap, top + 108, colWidth, 20,
                new TranslatableText("gui.cancel"), button -> onClose()));
        addButton(TranslatorUiText.button(left + 2 * (colWidth + gap), top + 108, colWidth, 20,
                new TranslatableText("screen.universal_translator.tencent.clear"), button -> clearAll()));
    }
    ...
    public void render(MatrixStack matrices, int mouseX, int mouseY, float delta) {
        ...
        TranslatorUiText.drawLeft(matrices, this.textRenderer,
                new TranslatableText("screen.universal_translator.tencent.secret_id"),
                left, top - 11, 0xFFFFFF, width);
        TranslatorUiText.drawLeft(matrices, this.textRenderer,
                new TranslatableText("screen.universal_translator.tencent.secret_key"),
                left, top + 25, 0xFFFFFF, width);
        TranslatorUiText.drawLeft(matrices, this.textRenderer,
                new TranslatableText("screen.universal_translator.tencent.model"),
