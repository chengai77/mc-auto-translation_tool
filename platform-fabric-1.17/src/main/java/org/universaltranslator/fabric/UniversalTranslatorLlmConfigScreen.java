...
final class UniversalTranslatorLlmConfigScreen extends Screen implements LocalTranslationScreen {
    ...
    protected void init() {
        ...
        addDrawableChild(TranslatorUiText.button(left, top + 108, buttonWidth, 20,
                new TranslatableText("screen.universal_translator.llm.save"), button -> save()));
        addDrawableChild(TranslatorUiText.button(left + buttonWidth + gap, top + 108, buttonWidth, 20,
                new TranslatableText("gui.cancel"), button -> onClose()));
        addDrawableChild(TranslatorUiText.button(left + (buttonWidth + gap) * 2, top + 108, buttonWidth, 20,
