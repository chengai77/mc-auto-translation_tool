...
final class UniversalTranslatorTencentConfigScreen extends Screen implements LocalTranslationScreen {
    ...
    protected void init() {
        ...
        addDrawableChild(TranslatorUiText.button(left, top + 108, colWidth, 20,
                new TranslatableText("screen.universal_translator.tencent.save"), button -> save()));
        addDrawableChild(TranslatorUiText.button(left + colWidth + gap, top + 108, colWidth, 20,
                new TranslatableText("gui.cancel"), button -> onClose()));
        addDrawableChild(TranslatorUiText.button(left + 2 * (colWidth + gap), top + 108, colWidth, 20,
