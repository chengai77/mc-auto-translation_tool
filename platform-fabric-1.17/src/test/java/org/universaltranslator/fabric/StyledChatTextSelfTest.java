...
public final class StyledChatTextSelfTest {
    private static final Identifier INLINE_FONT =
            new Identifier("universal_translator", "inline_test");
    ...
    private static void preservesUrlAttachment() {
        ...
        Text source = new LiteralText("")
                .append(new LiteralText("Click ").formatted(Formatting.YELLOW))
                .append(new LiteralText("[HERE]").setStyle(linkStyle))
                .append(new LiteralText(" to install").formatted(Formatting.YELLOW));
    ...
    private static void preservesCommandAttachments() {
        ...
        MutableText source = new LiteralText("")
                .append(new LiteralText("Difficulty: ").formatted(Formatting.AQUA))
    ...
    private static void preservesDecoratedText() {
        Style valueStyle = Style.EMPTY.withColor(Formatting.GREEN)
                ...
                .withInsertion("ready");
        Text source = new LiteralText("")
                .append(new LiteralText("Status: ").formatted(Formatting.AQUA))
                .append(new LiteralText("Ready").setStyle(valueStyle));
    ...
    private static void restoresInlineTextureFonts() {
        ...
        Text source = new LiteralText("")
                .append(new LiteralText("\uFFFC").setStyle(markerStyle))
                .append(new LiteralText(" Open "))
                .append(new LiteralText("\uFFFC").setStyle(markerStyle));
        ...
        Text translated = new LiteralText(semantic.replace("Open", "打开"));
    ...
    private static void rejectsBrokenStyleTemplates() {
        Text source = new LiteralText("")
                .append(new LiteralText("Action: "))
                .append(new LiteralText("Run").setStyle(
    ...
    private static Text button(
        ...
        return new LiteralText(label).setStyle(
