...
final class StyledChatText {
    ...
    static FormattedText rebuild(FormattedText source, String translated, Style fallbackStyle) {
        ...
        if (styled.allVisibleTextUses(sourceRuns.get(0).style())) {
            return Component.literal(translated).setStyle(sourceRuns.get(0).style());
        }
    ...
    private static StyledText styledText(FormattedText source, Style fallbackStyle) {
        if (source instanceof Component) {
            return styledText(((Component) source).getVisualOrderText(), fallbackStyle);
        }
    ...
    private static StyledText styledText(FormattedCharSequence text, Style fallbackStyle) {
