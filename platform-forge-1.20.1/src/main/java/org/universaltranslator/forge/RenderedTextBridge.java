...
public final class RenderedTextBridge {
    ...
    public static Text translatePlainHologramText(Text text) {
        ...
        String translated = ForgeTranslationRuntime.translatePlainHologramForRender(
    ...
    public static Text translateEntityName(Entity entity, Text text) {
        ...
        String translated = ForgeTranslationRuntime.translateForRender(
    ...
    public static Text translateHudText(Text text, TextKind kind) {
        return translateDirectText(text, kind);
    }

    public static boolean preloadUrgentHudText(Text text, TextKind kind, boolean overlayTinted) {
        return ForgeTranslationRuntime.preloadUrgentHudText(text, kind, overlayTinted);
    }
    ...
    public static StringVisitable translateChatMessage(
        ...
        String translated = ForgeTranslationRuntime.translateCompleteForRender(
    ...
    private static List<Text> translateTooltip(List<Text> lines, boolean itemTooltip) {
        if (lines == null || lines.isEmpty()
                || ForgeLocalTextGuard.isTranslatorScreen(MinecraftClient.getInstance())) {
            return lines;
        }
        ...
        List<String> translatedLines = ForgeTranslationRuntime.translateIndependentLinesForRender(
    ...
    private static Text translateDirectText(Text text, TextKind kind) {
        ...
        String original = text.getString();
        String translated = ForgeTranslationRuntime.translateForRender(original, kind);
    ...
    private static String translateRaw(
        ...
        if (containsLineBreak(text)) {
            return ForgeTranslationRuntime.translateCompleteForRender(text, currentKind);
        }
        return ForgeTranslationRuntime.translateForRender(text, currentKind);
    }
