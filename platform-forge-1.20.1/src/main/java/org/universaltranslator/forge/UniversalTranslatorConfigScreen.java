...
final class UniversalTranslatorConfigScreen extends Screen implements LocalTranslationScreen {
    ...
    private void saveAndApply() {
        ...
        try {
            ...
            if (ForgeConfig.isOfficialProvider(selectedProvider)
            ...
            ForgeConfig updated = buildConfig();
            ...
            if (updated.enabled && ForgeConfig.isOfficialProvider(updated.provider)
    ...
    private boolean isOfficialProvider() {
        return ForgeConfig.isOfficialProvider(provider);
    }
    ...
    private void saveClearedConfig() {
        ForgeConfig cleared = buildConfig();
        try {
            cleared.save();
        ...
        try {
            ForgeTranslationRuntime.initialize(cleared);
        } catch (Exception ignored) {
            // 下次保存刷新
        }
    }
