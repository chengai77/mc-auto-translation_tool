...
final class UniversalTranslatorLlmConfigScreen extends Screen implements LocalTranslationScreen {
    ...
    public void render(DrawContext context, int mouseX, int mouseY, float delta) {
        ...
        TranslatorUiText.drawLeft(context, this.textRenderer,
                Text.translatable("screen.universal_translator.llm.endpoint"),
                left, top - 11, 0xFFFFFF, width);
        TranslatorUiText.drawLeft(context, this.textRenderer,
                Text.translatable("screen.universal_translator.llm.model"),
                left, top + 25, 0xFFFFFF, width);
        TranslatorUiText.drawLeft(context, this.textRenderer,
                Text.translatable("screen.universal_translator.llm.api_key"),
