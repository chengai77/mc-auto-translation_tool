...
public final class UniversalTranslatorForgeClient {
    ...
    public static synchronized void register(IEventBus modBus) {
        ...
        initialized = true;
        initializeRuntime();
        modBus.addListener(UniversalTranslatorForgeClient::registerKeyMappings);
        MinecraftForge.EVENT_BUS.addListener(UniversalTranslatorForgeClient::onClientTick);
        MinecraftForge.EVENT_BUS.addListener(UniversalTranslatorForgeClient::onClientChat);
        MinecraftForge.EVENT_BUS.addListener(UniversalTranslatorForgeClient::onGameShuttingDown);
    }
    ...
    private static void toggleTranslation(MinecraftClient client) {
        ...
        try {
            ...
            ForgeTranslationRuntime.showLocalOverlay(
    ...
    private static void notifyRuntimeStatus(MinecraftClient client, boolean connected) {
        ...
        String localized = TranslationStatusLocalizer.localize(
                current, UniversalTranslatorForgeClient::tr);
        if (failure) {
