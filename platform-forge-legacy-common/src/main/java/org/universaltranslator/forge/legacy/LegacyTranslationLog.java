...
final class LegacyTranslationLog {
    private static final int MAX_ENTRIES = 300;
    private static final List<Entry> ENTRIES = new ArrayList<Entry>();

    private LegacyTranslationLog() {
    }
    ...
    static synchronized void add(String original, String translated) {
        ...
        ENTRIES.add(0, new Entry(cleanOriginal, cleanTranslated));
    ...
    static final class Entry {
        ...
        Entry(String original, String translated) {
