...
import org.universaltranslator.neoforge.UniversalTranslatorNeoForgeClient;
...
public final class UniversalTranslatorNeoForgeMod {
    ...
    public UniversalTranslatorNeoForgeMod(IEventBus modBus) {
        UniversalTranslatorNeoForgeClient.register(modBus);
    }
}
