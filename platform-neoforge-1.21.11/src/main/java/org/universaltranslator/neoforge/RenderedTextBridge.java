...
public final class RenderedTextBridge {
    ...
    public static String translate(String text, SignTranslationContext.WidthMeasurer measurer, TextKind kind) {
        ...
        return TranslationTextStyling.applyTranslatedStyle(
                text, translated, NeoForgeTranslationRuntime.translatedTextColor());
    }
    ...
    public static Text translate(Text text) {
        ...
        if (containsLineBreak(original)) {
            return translateCompleteText(text, currentKind);
        }
    ...
    public static Text translatePlainHologramText(Text text) {
        ...
        String translated = NeoForgeTranslationRuntime.translatePlainHologramForRender(
    ...
    public static Text translateEntityName(Entity entity, Text text) {
        ...
        String translated = NeoForgeTranslationRuntime.translateForRender(
    ...
    public static boolean preloadUrgentHudText(Text text, TextKind kind, boolean overlayTinted) {
        return NeoForgeTranslationRuntime.preloadUrgentHudText(text, kind, overlayTinted);
    }
    ...
    public static OrderedText translate(
        ...
        if (TranslationRenderContext.isTranslationSuppressed()) {
            return TranslationBypassText.wrap(text);
        }
        TextKind currentKind = kind == null ? TranslationRenderContext.current() : kind;
    ...
    public static StringVisitable translateChatMessage(
        ...
        String translated = NeoForgeTranslationRuntime.translateCompleteForRender(
    ...
    private static List<Text> translateTooltip(List<Text> lines, boolean itemTooltip) {
        ...
        List<String> translatedLines = NeoForgeTranslationRuntime.translateIndependentLinesForRender(
    ...
    private static Text translateDirectText(Text text, TextKind kind) {
        ...
        String original = text.getString();
        String translated = NeoForgeTranslationRuntime.translateForRender(original, kind);
    ...
    private static String translateRaw(
        ...
        if (containsLineBreak(text)) {
            return NeoForgeTranslationRuntime.translateCompleteForRender(text, currentKind);
        }
        return NeoForgeTranslationRuntime.translateForRender(text, currentKind);
    }
    ...
    static Style translatedStyle(Style original) {
        ...
        // 翻译文本使用默认字体
        original = original.withFont(StyleSpriteSource.DEFAULT);
        TranslationTextColor color = NeoForgeTranslationRuntime.translatedTextColor();
