...
final class UniversalTranslatorTencentConfigScreen extends Screen {
    ...
    public void render(DrawContext context, int mouseX, int mouseY, float delta) {
        ...
        context.drawTextWithShadow(this.textRenderer,
                Text.translatable("screen.universal_translator.tencent.secret_id"), left, top - 11, 0xFFFFFF);
        context.drawTextWithShadow(this.textRenderer,
                Text.translatable("screen.universal_translator.tencent.secret_key"), left, top + 25, 0xFFFFFF);
        context.drawTextWithShadow(this.textRenderer,
                Text.translatable("screen.universal_translator.tencent.model"), left, top + 61, 0xFFFFFF);
        if (!status.isEmpty()) {
