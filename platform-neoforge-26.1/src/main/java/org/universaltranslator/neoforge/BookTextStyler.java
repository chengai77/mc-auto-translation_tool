...
final class BookTextStyler {
    ...
    private static String translatedFragment(String sourceText) {
        String translated = NeoForgeTranslationRuntime.translateStyleFragmentForRender(sourceText, TextKind.BOOK);
    ...
    private static MutableComponent buildText(String translated, Style plainStyle, List<TargetRun> targets) {
    ...
    private static Style displayStyle(Style original) {
        ...
        switch (color) {
            case GREEN: return style.withColor(ChatFormatting.GREEN);
            case GOLD: return style.withColor(ChatFormatting.GOLD);
            case LIGHT_PURPLE: return style.withColor(ChatFormatting.LIGHT_PURPLE);
            case YELLOW: return style.withColor(ChatFormatting.YELLOW);
            case WHITE: return style.withColor(ChatFormatting.WHITE);
            case AQUA: return style.withColor(ChatFormatting.AQUA);
            case ORIGINAL:
    ...
    private static boolean isDecorated(Style style) {
        ...
        return style.getColor() != null
                ...
                || style.isObfuscated()
                || (style.getFont() != null && !FontDescription.DEFAULT.equals(style.getFont()));
    }
