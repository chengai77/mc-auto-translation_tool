...
public final class UniversalTranslatorNeoForgeClient {
    ...
    private static void onClientTick(ClientTickEvent.Post event) {
        ...
        while (OPEN_SETTINGS.consumeClick()) {
            ...
            try { client.gui.setScreen(new UniversalTranslatorConfigScreen(client.gui.screen(), NeoForgeConfig.load(FMLPaths.CONFIGDIR.get()))); }
    ...
    private static void toggleTranslation(Minecraft client) {
        ...
        try {
            ...
            NeoForgeTranslationRuntime.showLocalOverlay(Component.translatable("message.universal_translator.toggle_failed"), false);
        }
    }
